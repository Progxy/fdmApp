...
class StampaBuilder extends StatefulWidget {
  @override
  _StampaBuilderState createState() => _StampaBuilderState();
}

class _StampaBuilderState extends State<StampaBuilder> {
  @override
  Widget build(BuildContext context) {
    generateContent() async {
      final Map contents = await ContentManager().getArticle();
      //TODO: change to getStampa();
